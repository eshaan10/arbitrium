...
Keeps the pure matcher (:mod:`marketedge.matching`) free of DB concerns while
...
from marketedge.matching import EventKey, MatchCandidate, MatchStatus, match_event
